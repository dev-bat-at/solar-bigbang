    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                'specifications' => [
                    ['label_vi' => 'Loại Cell', 'label_en' => 'Cell Type', 'value_vi' => 'N-Type Monocrystalline', 'value_en' => 'N-Type Monocrystalline'],
                    ['label_vi' => 'Số lượng Cell', 'label_en' => 'No. of Cells', 'value_vi' => '144 (6×24)', 'value_en' => '144 (6×24)'],
                    ['label_vi' => 'Kích thước', 'label_en' => 'Dimensions', 'value_vi' => '2278×1134×35mm', 'value_en' => '2278×1134×35mm'],
                    ['label_vi' => 'Trọng lượng', 'label_en' => 'Weight', 'value_vi' => '28 kg', 'value_en' => '28 kg'],
                ],
                'documents' => [],
                'faqs' => [
                    ['question_vi' => 'Tấm pin này chịu lực tốt không?', 'question_en' => 'Is this panel durable?', 'answer_vi' => 'Tấm pin có khả năng chịu tải trọng tuyết lên đến 5400Pa và tải trọng gió lên đến 2400Pa.', 'answer_en' => 'The panel can withstand snow loads up to 5400Pa and wind loads up to 2400Pa.'],
                    ['question_vi' => 'Bảo hành như thế nào?', 'question_en' => 'How is the warranty?', 'answer_vi' => 'Bảo hành vật lý 12 năm và bảo hành hiệu suất tuyến tính 25 năm.', 'answer_en' => '12-year product warranty and 25-year linear power warranty.'],
                ],
            ],
            [
                'code' => 'INV-LUX-6K',
                'slug' => 'inverter-hybrid-luxpower-6kw',
                'product_category_id' => $inverterCategory?->id,
                'product_subcategory_id' => $inverterSubcategory?->id,
                ...
                'specifications' => [
                    ['label_vi' => 'Công suất danh định', 'label_en' => 'Nominal Power', 'value_vi' => '6000W', 'value_en' => '6000W'],
                    ['label_vi' => 'Số cổng mPPT', 'label_en' => 'MPPT Trackers', 'value_vi' => '2 cổng (độc lập)', 'value_en' => '2 (independent)'],
                    ['label_vi' => 'Giao tiếp hệ thống', 'label_en' => 'Communication', 'value_vi' => 'RS485, CAN, Wi-Fi', 'value_en' => 'RS485, CAN, Wi-Fi'],
                    ['label_vi' => 'Chống nước', 'label_en' => 'IP Rating', 'value_vi' => 'IP65', 'value_en' => 'IP65'],
                ],
                'documents' => [],
                'faqs' => [
                    ['question_vi' => 'Sản phẩm có tương thích với pin Lithium nào?', 'question_en' => 'Which Lithium batteries are compatible?', 'answer_vi' => 'Luxpower tương thích với hơn 95% các thương hiệu pin Lithium trên thị trường như Pylontech, Deye, Giga,...', 'answer_en' => 'Luxpower is compatible with over 95% of Lithium battery brands on the market such as Pylontech, Deye, Giga,...'],
                ],
            ],
        ];
